...
def executar_questionario():
    ...
    tam = input("-> ")
    if tam == "1": propriedades["tamanho"] = 50
    ...
    if propriedades["objetivo"] == Objetivo.ORDENAR.value:
        ...
        ordem = input("-> ")
        if ordem == "1": propriedades["grau_ordenacao"] = 0.05
        elif ordem == "3": propriedades["grau_ordenacao"] = 1.0
        else: propriedades["grau_ordenacao"] = 0.5
    else:
    ...
    if mem == 'S': propriedades["restricao_memoria"] = True
